...
module.exports = {"coverPass256":coverPass256, "coverPass":coverPass};


function coverPass256(thePass, theName, code) {
  ...
  thePass = (!code)? crypto.createHash('sha256').update(thePass).digest('hex'): hex_sha256(thePass);
  return thePass;
}
